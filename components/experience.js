  ...
  return (
    <div className="experience-section">
      <section className="experience-container container">
        ...
        <div className="items">
          <div className="item">
            <p className="year">{t("Nov 2021 - Current")}</p>
            <p className="job">{t("Frontend Developer")}</p>
            <p>
              <i className="fal fa-map-pin" />
              {t("Genesis Cloud - Munich, Germany")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a
                href="https://www.genesiscloud.com"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <ul>
              <li>{t("Define frontend architecture of dashboard")}</li>
              <li>{t("Create task for developers and code review")}</li>
              <li>
                {t(
                  "Refactor old version of dashboard with new architecture, using  functional components, Redux toolkit, Chakra UI, SWR."
                )}
              </li>
              <li>
                {t(
              ...
              <li>{t("Support and maintenance of website and dashboard")}</li>
            </ul>
          </div>
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Mygento - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a href="https://www.mygento.ru" target="_blank" rel="noreferrer">
                https://www.mygento.ru
              </a>
            </p>
            <ul>
              <li>
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Autoharakter - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a
            ...
            <ul>
              ...
              <li>
                {t("Optimizing SEO for Google and Yandex searching engines")}
              </li>
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Procent - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Granit - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a href="http://granitbrz.ru" target="_blank" rel="noreferrer">
                http://granitbrz.ru
              </a>
            </p>
            <ul>
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Enduro - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a href="http://crimeatrophy.ru" target="_blank" rel="noreferrer">
                http://crimeatrophy.ru
              </a>
            </p>
            <ul>
              <li>
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("Maskom - Moscow, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a
                href="https://maskomzoloto.ru"
                target="_blank"
                rel="noreferrer"
              >
                https://maskomzoloto.ru
              </a>
            </p>
            <ul>
              {t("Development of UI:")}
          ...
          <div className="item">
            ...
            <p>
              <i className="fal fa-map-pin" />
              {t("LYYK & Lomonosova 22 - Saint Petersburg, Russia")}
            </p>
            <p>
              <i className="fal fa-link" />
              <a
                href="https://www.instagram.com/lomonosova22"
                target="_blank"
                rel="noreferrer"
              >
                https://lomonosova22
            ...
            <ul>
              ...
              <li>
                {t("Making research and hire team, testing, making test task")}
              </li>
            </ul>
          </div>
        </div>
